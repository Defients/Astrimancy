/**
 * Navigation component for main tab navigation
 */
...
export default function Navigation() {
  ...
  return (
    <nav className="desktop-nav hidden md:block border-t border-gray-800 py-2">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-1">
          <button
            className={`nav-tab ${
              state.views.currentView === "browse" ? "active" : ""
            }`}
          ...
          <button
            className={`nav-tab ${
              state.views.currentView === "favorites" ? "active" : ""
            }`}
          ...
          <button
            className={`nav-tab ${
              state.views.currentView === "spread" ? "active" : ""
            }`}
          ...
          <button
            className={`nav-tab ${
              state.views.currentView === "comparison" ? "active" : ""
            }`}
        ...
        {/* Display mode toggle */}
        <div className="display-mode-toggles">
          <button
            className={`feature-button ${
              state.ui.displayMode === "grid" ? "active" : ""
            }`}
            onClick={() =>
          ...
          <button
            className={`feature-button ${
              state.ui.displayMode === "carousel" ? "active" : ""
            }`}
            onClick={() =>
